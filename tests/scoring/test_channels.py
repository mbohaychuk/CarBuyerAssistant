...
def test_condition_position_returns_canonical_values() -> None:
    ...
    assert condition_position("poor") == 0.25  # noqa: PLR2004
    assert condition_position("decent") == 0.5  # noqa: PLR2004
    assert condition_position("good") == 0.75  # noqa: PLR2004
    assert condition_position("great") == 1.0


def test_condition_position_unknown_falls_back_to_midpoint() -> None:
    assert condition_position("garbage-string") == 0.5  # noqa: PLR2004
...
def test_condition_position_with_sparse_flag_shifts_decent_toward_p25() -> None:
    ...
    assert condition_position("decent", sparse=True) == 0.35  # noqa: PLR2004
    # Confident "decent" stays at midpoint.
    assert condition_position("decent", sparse=False) == 0.5  # noqa: PLR2004
...
def test_condition_position_sparse_only_affects_decent() -> None:
    ...
    assert condition_position("good", sparse=True) == 0.75  # noqa: PLR2004
